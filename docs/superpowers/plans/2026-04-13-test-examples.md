...
Run: `cd /Users/akolodkin/Developer/work/AgentsStack && uv run python -c "from agentstack import load_agent; a = load_agent('examples/minimal/agentstack.yaml'); print(f'{a.name}: platform={a.platform.type}, sessions={a.sessions}')"`
...
Run:
```bash
cd /Users/akolodkin/Developer/work/AgentsStack/examples/minimal
...
Run: `cd /Users/akolodkin/Developer/work/AgentsStack && uv run python -c "from agentstack import load_agent; a = load_agent('examples/sessions-postgres/agentstack.yaml'); print(f'{a.name}: sessions={a.sessions.engine}')"`
...
Run: `cd /Users/akolodkin/Developer/work/AgentsStack && uv run python -c "from agentstack import load_agent; a = load_agent('examples/memory-agent/agentstack.yaml'); print(f'{a.name}: sessions={a.sessions.engine}, memory={a.memory.engine}')"`
...
Run:
```bash
cd /Users/akolodkin/Developer/work/AgentsStack/examples/memory-agent
ANTHROPIC_API_KEY="sk-cp-9vv1vReqwBQ4-dIOlA72JvvtM-YW1nffg5JZ7Ng8tDFyk_nbiTLYDfWqx9afr7cPaT7QY70ACE63-CZCoN2n_oibuTTxj9YFAE7_gidPnPUCXm8Z1_ksQEk" uv run agentstack apply
```
...
```bash
cd /Users/akolodkin/Developer/work/AgentsStack/examples/mcp-files
ANTHROPIC_API_KEY="sk-cp-9vv1vReqwBQ4-dIOlA72JvvtM-YW1nffg5JZ7Ng8tDFyk_nbiTLYDfWqx9afr7cPaT7QY70ACE63-CZCoN2n_oibuTTxj9YFAE7_gidPnPUCXm8Z1_ksQEk" uv run agentstack apply
```
...
Run: `cd /Users/akolodkin/Developer/work/AgentsStack/examples/code-first && uv run python -c "from agentstack_cli.loader import find_agent_file, load_agent_from_file; p = find_agent_file(); a = load_agent_from_file(p); print(f'{a.name}: sessions={a.sessions.engine}, memory={a.memory.engine}, port={a.port}')"`
...
Run:
```bash
cd /Users/akolodkin/Developer/work/AgentsStack/examples/code-first
ANTHROPIC_API_KEY="sk-cp-9vv1vReqwBQ4-dIOlA72JvvtM-YW1nffg5JZ7Ng8tDFyk_nbiTLYDfWqx9afr7cPaT7QY70ACE63-CZCoN2n_oibuTTxj9YFAE7_gidPnPUCXm8Z1_ksQEk" uv run agentstack apply
```

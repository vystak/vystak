...
Run: `cd ~/Developer/work/AgentsStack && uv run pytest packages/python/agentstack/tests/ -v`
...
Run:
```bash
cd ~/Developer/work/AgentsStack && pnpm install
...
Run: `cd ~/Developer/work/AgentsStack && just test`

...
Run:
```bash
cd /Users/akolodkin/Developer/work/AgentsStack && uv sync
```
...
Run:
```bash
cd /Users/akolodkin/Developer/work/AgentsStack && uv run python -c "from azure.mgmt.rdbms.postgresql_flexibleservers import PostgreSQLManagementClient; print('OK')"
```
Expected: Prints `OK`.
...
Run:
```bash
cd /Users/akolodkin/Developer/work/AgentsStack && uv run pytest packages/python/agentstack-provider-azure/tests/test_postgres_node.py -v
```
...
Run:
```bash
cd /Users/akolodkin/Developer/work/AgentsStack && uv run python -c "from agentstack_provider_azure.nodes import AzurePostgresNode; print('OK')"
```
Expected: Prints `OK`.
...
Run:
```bash
cd /Users/akolodkin/Developer/work/AgentsStack && uv run pytest packages/python/agentstack-provider-azure/tests/ -v
```
...
Run:
```bash
cd /Users/akolodkin/Developer/work/AgentsStack && uv run pytest packages/python/agentstack-provider-azure/tests/test_nodes.py::TestContainerAppNode::test_provision_with_postgres_env_vars -v
```
...
Run:
```bash
cd /Users/akolodkin/Developer/work/AgentsStack && uv run pytest packages/python/agentstack-provider-docker/tests/ -v
```

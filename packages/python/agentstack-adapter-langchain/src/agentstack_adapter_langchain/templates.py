...
def generate_server_py(agent: Agent) -> str:
    ...
    lines.append("        )")
    lines.append("")
    lines.append("    output = [ResponseOutput(type='message', role='assistant', content=[{'type': 'output_text', 'text': response_text}])]")
    ...
    lines.append("")
    lines.append("        final_output = [ResponseOutput(type='message', role='assistant', content=[{'type': 'output_text', 'text': full_text}])]")
    lines.append("")

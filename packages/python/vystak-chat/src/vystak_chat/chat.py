...
class ChatREPL:
    ...
    def __init__(self):
        ...
        self._model: str = ""  # OpenAI model ID (e.g., "vystak/assistant-agent")
    ...
    def _show_welcome(self):
        console.print()
        console.print("[bold]Vystak Chat[/bold] v0.1.0", style="success")
    ...
    async def run(self):
        ...
        history_path = Path.home() / ".vystak" / "chat_history"

...
Lives alongside the langgraph checkpointer so the per-thread model
selection persists across container restarts (when SQLite-backed) and
across heartbeat fires.
"""

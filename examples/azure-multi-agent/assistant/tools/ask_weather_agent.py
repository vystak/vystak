...
if _gateway:
    ...
    WEATHER_AGENT_URL = os.environ.get("WEATHER_AGENT_URL", "http://vystak-weather-agent:8000") + "/a2a"
...
async def ask_weather_agent(question: str) -> str:
    ...
    try:
        ...
        async with httpx.AsyncClient(timeout=60) as client:
            response = await client.post(WEATHER_AGENT_URL, json=payload)
        ...
        response_text = " ".join(texts) if texts else "No response from weather agent"
